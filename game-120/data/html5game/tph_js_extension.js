...
{   
    ...
    {        
        // Controller
        var controller = gamee.controller.requestController('FourButtons');
        
        controller.buttons.left.on('keydown', function() { gmCallback.gamee_onKey(0, 1); });
        controller.buttons.left.on('keyup', function() { gmCallback.gamee_onKey(0, 0); });          
        controller.buttons.right.on('keydown', function() { gmCallback.gamee_onKey(1, 1); });
        controller.buttons.right.on('keyup', function() { gmCallback.gamee_onKey(1, 0); });        
        controller.buttons.up.on('keydown', function() { gmCallback.gamee_onKey(2, 1); });
        controller.buttons.A.on('keydown', function() { gmCallback.gamee_onKey(2, 1); });
