  ...
  return new Map(
    t.map(function (t) {
      ...
      return (
        ...
        (u.style.zIndex = i),
        o.appendChild(u),
        [a, { canvas: u, context: u.getContext("2d"), z: i }]
      );
    })
  );
}
...
function preloadSounds(t, e, n) {
  var o =
      "probably" === Modernizr.audio.mp3 && new Set(n).has("mp3")
        ? ".mp3"
        : ".wav",
    r = AUDIOCTX;
  return preload(
...
function _playSound(t, e, n) {
  var o = AUDIOCTX,
    ...
    a = o.createGain();
  (r.buffer = t),
    (a.gain.value = void 0 !== n ? n : 1),
    r.connect(a),
    a.connect(o.destination),
    r.start(o.currentTime + e / 1e3);
}
function playSilentSound() {
  ...
  (n.buffer = e),
    ...
    n.start(0),
    "suspended" === n.context.state && n.context.resume();
}
function _toConsumableArray(t) {
  if (Array.isArray(t)) {
    for (var e = 0, n = Array(t.length); e < t.length; e++) n[e] = t[e];
...
function getScore(t, e, n, o, r) {
  ...
  return Math.round(
    linterpol(r, [Math.pow(5, a), 1], [Math.pow(5, a + 1), 1])[0]
  );
}
!(function (t, e, n) {
  function o(t, e) {
  ...
  var a = [],
    ...
    u = {
      ...
      addTest: function (t, e, n) {
        i.push({ name: t, fn: e, options: n });
      },
      addAsyncTest: function (t) {
        i.push({ name: null, fn: t });
      },
    },
    s = function () {};
  ...
  s.addTest("audio", function () {
    ...
    (function () {
      ...
      for (var f in i)
        if (i.hasOwnProperty(f)) {
          ...
          for (
            r = o(e.fn, "function") ? e.fn() : e.fn, u = 0;
            u < t.length;
            u++
          )
            (c = t[u]),
    ...
    (function (t) {
      ...
      s._config.enableClasses &&
        ((e += " " + n + t.join(" " + n)),
        l ? (c.className.baseVal = e) : (c.className = e));
    })(a),
    delete u.addTest,
    ...
    function t(t, e) {
      ...
      try {
        for (
          ...
          !(o = (i = u.next()).done) && (n.push(i.value), !e || n.length !== e);
          o = !0
        );
      } catch (t) {
        (r = !0), (a = t);
            ...
            []
              ...
              .forEach(function (n) {
                var o = _slicedToArray(n, 2),
                  ...
                  l = u ? (t - c) / u : 1;
                l >= 0 && i(l > 1 ? 1 : l),
                  (l >= 1 || 0 === u) && (e.removeAnimation(r), s && s());
              });
          },
        },
      ]),
  ...
  Game = (function () {
    function t(e, n, o, r) {
      ...
      _classCallCheck(this, t),
        ...
        (this.width = o),
        (this.web = !!r && window.innerHeight === window.innerWidth),
        ...
        (this.canvas = initCanvases(n, this.realWidth, this.height)),
        (this.target = []
          .concat(_toConsumableArray(this.canvas.entries()))
          .reduce(
            function (t, e) {
              var n = _slicedToArray(e, 2),
                o = n[1];
        ...
        (gamee.onPause = function () {
          a.paused ||
            ((a.paused = 1), (a.pausedTime -= a.timestamp), a.onPause());
        }),
        (gamee.onResume = gamee.onUnpause = function () {
          a.paused &&
            ((a.paused = 0), (a.pausedTime += a.timestamp), a.onResume());
        }),
      ...
      if (
        ...
        void 0 !== e[t]
          ? void 0 === e[t].callbacks[r]
            ? (e[t].callbacks[r] = { cb: n, once: !!o })
            : "boolean" == typeof o && (e[t].callbacks[r].once = o)
          : ((e[t] = { callbacks: {} }),
            (e[t].callbacks[r] = { cb: n, once: !!o }));
      }
    }),
      ...
      (t.trigger = function (n, o) {
        if ("string" == typeof n && void 0 !== e[n])
          for (var r in e[n].callbacks) {
            ...
            "function" == typeof a.cb && a.cb(o),
              "boolean" == typeof a.once && !0 === a.once && t.off(n, a.cb);
          }
      });
  };
  ...
  (function (t) {
    ...
    function e(t) {
      (t.updateScore = function (t) {
        window.location.href = "panda://score/" + t;
      }),
        (t.requestController = function (t) {
          window.location.href = "panda://request-controller/" + t;
        }),
        (t.gameOver = function () {
    ...
    /iphone|ipod|ipad|android/.test(r)
...
var gamee = (function (t) {
  ...
  var o,
    ...
    a = {};
  return (
    Object.defineProperty(a, "score", {
      get: function () {
        return o;
      },
      set: function (e) {
        (o = e), t.$pandaNative.updateScore(o);
      },
    }),
    (a.gameOver = function () {
      t.$pandaNative.gameOver();
      $("#success").trigger("click");
      console.log("gameover")
    }),
    (a.gameStart = function () {
      t.$pandaNative.gameStart();
    }),
    (a.gameLoaded = function () {
      t.$pandaNative.gameLoaded();
    }),
    (a.onPause = r),
    (a.onStop = r),
    (a.onRestart = r),
    ...
    "gamee-web" === t.$pandaNative.type &&
      (a._keydown(function (t) {
        switch (t.keyCode) {
          case 80:
            a.onPause(), $pandaNative.gamePaused();
            break;
          case 82:
            a.onRestart();
        }
      ...
      e(t, "message", function (t) {
        switch (t.data[0]) {
          ...
          case "button_button_down":
            a.controller.trigger("keydown", { button: "button" });
            break;
          case "button_button_up":
            a.controller.trigger("keyup", { button: "button" });
            break;
          case "button_left_up":
            a.controller.trigger("keyup", { button: "left" });
            break;
          case "button_left_down":
            a.controller.trigger("keydown", { button: "left" });
            break;
          case "button_right_down":
            a.controller.trigger("keydown", { button: "right" });
            break;
          case "button_right_up":
            a.controller.trigger("keyup", { button: "right" });
            break;
          case "button_up_down":
            a.controller.trigger("keydown", { button: "up" });
            break;
          case "button_up_up":
            a.controller.trigger("keyup", { button: "up" });
            break;
          case "button_down_down":
            a.controller.trigger("keydown", { button: "down" });
            break;
          case "button_down_up":
            a.controller.trigger("keyup", { button: "down" });
            break;
          case "button_a_down":
            a.controller.trigger("keydown", { button: "A" });
            break;
          case "button_a_up":
            a.controller.trigger("keyup", { button: "A" });
            break;
          case "button_b_down":
            a.controller.trigger("keydown", { button: "B" });
            break;
          case "button_b_up":
            a.controller.trigger("keyup", { button: "B" });
            break;
          default:
...
!(function (t, e) {
  ...
  function a() {
    o.call(this),
      this.addButton(new n("left", 37)),
      this.addButton(new n("right", 39));
  }
  function i() {
    o.call(this),
      this.addButton(new n("up", 38)),
      this.addButton(new n("left", 37)),
      this.addButton(new n("right", 39)),
      this.addButton(new n("A", 32));
  }
  function u() {
    o.call(this),
      this.addButton(new n("up", 38)),
  ...
  function h(t, e) {
    ...
    if (
      ((e = e || {}),
      (o = new m[t]()),
      e.enableKeyboard && o.enableKeyboard(),
      e.buttons)
    )
  ...
  (e.controller = {
    requestController: function (e, n) {
      var o = h(e, n);
      return t.$pandaNative.requestController(e), (g = o), o;
    },
    additionalController: function (e, n) {
      var o = h(e, n);
      return t.$pandaNative.additionalController(e), o;
    },
    trigger: function () {
    ...
    (n.prototype = Object.create(p.constructor.prototype)),
    (n.constructor = n),
    (n.prototype.isDown = function () {
      return this._pressed;
    }),
    (o.prototype = Object.create(p.constructor.prototype)),
    (o.constructor = o),
    ...
    (o.prototype.enableKeyboard = function () {
      ...
      for (t in this.buttons)
        (n = this.buttons[t]), n.keyCode && (o[n.keyCode] = n);
  ...
  One23Game = (function (t) {
    function e(t, n, o, r) {
      ...
      var a = _possibleConstructorReturn(
          this,
          (e.__proto__ || Object.getPrototypeOf(e)).call(this, t, n, o, r)
        ),
        i = a;
      return (
        (a.yOffset = (a.height - 600) / 2),
        (a.sprites = new Map()),
        (a.sounds = new Map()),
        (a.maxEquationLength = 6),
        (a.equations = initEquations(a.maxEquationLength)),
        (a.equation = ""),
        (a.round = 0),
        (a.chrome = 1),
      ...
      _createClass(e, [
        ...
        },
        {
          ...
          value: function (t) {
            ...
            r.clearRect(this.xOffset, this.yOffset, this.width, this.height),
              r.drawImage(
                this.sprites.get("calc"),
                Math.floor(this.xOffset + 216 + n),
                Math.floor(this.yOffset + 90 + o)
              );
          },
        },
        {
          ...
          value: function (t) {
            ...
            return r < 0 || r > 400 || a < 0 || a > 200 || a % 75 > 50
              ? 0
              : Math.floor(a / 75) + 1;
          },
        },
        ...
        },
        {
          ...
          value: function (t, e, n) {
            ...
            if (
              (a.clearRect(this.xOffset, this.yOffset, this.width, this.width),
              "?" === e)
            )
              a.fillText(
                t + "=?",
                Math.floor(o - this.textWidth(t + "=?") / 2),
                r
              );
            else {
              ...
              a.save(),
                a.fillText(t + "=", Math.floor(o - (i + u) / 2), r),
                (a.fillStyle = "#432147"),
                a.fillText(e.toString(), Math.floor(o - (i + u) / 2 + i), r),
                a.restore();
            }
            a.clearRect(0, this.yOffset, this.xOffset, this.width),
              a.clearRect(
        ...
        },
        {
          ...
          value: function () {
            var t = Math.min(
                this.maxEquationLength - 2,
                getIndex(this.round, 5, 1.6)
              ),
              e = void 0;
            do {
              e = this.equations[t][
                Math.floor(this.equations[t].length * Math.random())
              ];
        ...
        },
        {
          ...
          value: function () {
            ...
            (t.fillStyle = "#39b4bf"),
              t.fillRect(this.xOffset, 0, this.width, this.height),
              this.drawCalculator([0, 0]),
              this.newRound();
          },
        },
        {
                ...
                function () {
                  new Promise(function (t) {
                    (e.target.ontouchstart = function (n) {
                      ...
                      e.augmentTouchEvents(),
                      e.round
                        ? e.scene.addAnimation(
                            function (t) {
                              e.drawButtons(t), (n = 1 - t);
                            },
                            e.config.timerDuration,
                            function () {
                              return t(0);
                            },
                            e.now()
        ...
        },
        {
          ...
          value: function (t, e) {
            ...
            if ((this.scene.removeAllAnimations(), t === this.equation[1])) {
              this.playSound("correct", 0),
                this.scene.addAnimation(
                  function (t) {
                    var e =
                        (t - n.config.eqResultDurationRatio) /
                        (1 - n.config.eqResultDurationRatio),
                  ...
                  this.config.eqDurationOut,
                  function () {
                    (n.score += getScore(
                      n.round,
                      5,
                      1.6,
                      n.maxEquationLength - 2,
                      e
                    )),
                      console.log(n.score),
                      n.round++,
              ...
              var o = []
                .concat(_toConsumableArray(Array(6).keys()))
                .map(function (t) {
                  return 4 === t || 5 === t || 0 === t
                    ? 0
                    : Math.floor(50 * (2 * Math.random() - 1));
                });
              this.scene.addAnimation(
                function (t) {
                  var e = Math.floor(4 * t),
                    ...
                    i =
                      (Math.abs(o[e + 1] - o[e]),
                      -Math.abs(100 * Math.sin(4 * Math.PI * t)) *
                        Math.pow(1 - t, 1));
                  n.drawCalculator([a, i]);
                },
                this.config.eqDurationOut * this.config.eqResultDurationRatio,
                function () {},
                this.now()
              );
            } else this.gameOver();
