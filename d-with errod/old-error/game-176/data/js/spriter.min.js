  ...
  var e = t.eImageNameType,
    i = (function () {
      function t(t) {
        ...
        (this._imageNameType =
          i && "undefined" != typeof t.imageNameType
            ? t.imageNameType
            : e.NAME_ONLY),
          (this._minDefs =
            i && "undefined" != typeof t.minDefs ? t.minDefs : null);
      }
      return (
        (t.prototype.processed = function () {
        ...
        (t.prototype.setMinimized = function (t) {
          (this._minimized = t),
            t && ((this._minDefsStack = []), null === this._minDefs);
        }),
  ...
  var e = (function (e) {
    ...
    return (
      ...
      (i.prototype.getFolder = function (e) {
        ...
        for (
          var n = 0, r = "", o = this._bin.getUint8(this._tmpPosition++) - 1;
          o >= 0;
          o--
        )
      ...
      (i.prototype.getFile = function (e) {
        ...
        for (
          var n = 0,
            ...
            o = 0,
            s = 0,
            a = this._bin.getUint8(this._tmpPosition++) - 1;
          a >= 0;
          a--
        )
          switch (this._bin.getUint8(this._tmpPosition++)) {
      ...
      (i.prototype.getObjectInfo = function (e, n) {
        ...
        for (
          var r = "",
            ...
            s = 0,
            a = 0,
            p = this._bin.getUint8(this._tmpPosition++) - 1;
          p >= 0;
          p--
        )
          switch (this._bin.getUint8(this._tmpPosition++)) {
      ...
      (i.prototype.getMainlineKey = function (e) {
        this._tmpPosition = this.getAttribsPosition(e);
        for (
          var n = 0, r = 0, o = this._bin.getUint8(this._tmpPosition++) - 1;
          o >= 0;
          o--
        )
          switch (this._bin.getUint8(this._tmpPosition++)) {
      ...
      (i.prototype.getTimelineKey = function (e, n, r) {
        ...
        for (
          var o = 0,
            ...
            l = 0,
            _ = 0,
            u = this._bin.getUint8(this._tmpPosition++) - 1;
          u >= 0;
          u--
        )
          switch (this._bin.getUint8(this._tmpPosition++)) {
        ...
        var f =
          ...
          y = !1;
        14 === c
          ? (d = new t.KeyBone(n, o, s))
          : 15 === c && ((d = new t.KeyObject(n, o, s)), (y = !0)),
          0 !== a && d.setCurve(a, p, h, l, _),
          (this._tmpPosition = this.getAttribsPosition(f));
        var g = d.info;
        (g.x = 0),
          (g.y = 0),
          (g.scaleX = 1),
        ...
        if (y) {
          ...
          (g.pivotX = T ? m : E.pivotX),
            (g.pivotY = 1 - (I ? b : 1 - E.pivotY));
        }
        return d;
      }),
    ...
    return (
      ...
      (i.prototype.getFile = function (e) {
        return void 0 !== e.type && "sound" === e.type
          ...
          : new t.File(
              this.parseInt(e, "id"),
              this.getFileName(this.parseString(e, "name")),
      ...
      (i.prototype.getTimelineKey = function (e, i, n) {
        ...
        void 0 !== e[_]
          ? ((c = e[_]),
            (f = new t.KeyBone(i, r, o)),
            this.setMinDefsToElementName("bone"))
          : void 0 !== e[u] &&
            ((c = e[u]),
            (f = new t.KeyObject(i, r, o)),
            this.setMinDefsToElementName("object"),
            (d = !0)),
          "linear" !== s &&
            f.setCurve(t.Types.getCurveTypeForName(s), a, p, h, l);
        var y = f.info;
        if (
          ((y.x = this.parseFloat(c, "x")),
          (y.y = -this.parseFloat(c, "y")),
          (y.scaleX = this.parseFloat(c, "scale_x", 1)),
          (y.scaleY = this.parseFloat(c, "scale_y", 1)),
          (y.angle = 360 - this.parseFloat(c, "angle")),
          (y.alpha = this.parseFloat(c, "a", 1)),
          d)
        ) {
          ...
          (y.pivotX = this.parseFloat(c, "pivot_x", T.pivotX)),
            (y.pivotY = 1 - this.parseFloat(c, "pivot_y", 1 - T.pivotY));
        }
    ...
    return (
      ...
      (i.prototype.getTimelineKey = function (e, i, n) {
        var r = this.parseInt(e, "time"),
          ...
          d = !1;
        c.tagName === _
          ? ((f = new t.KeyBone(i, r, o)), this.setMinDefsToElementName("bone"))
          : c.tagName === u &&
            (this.setMinDefsToElementName("object"),
            (f = new t.KeyObject(i, r, o)),
            (d = !0)),
...
!(function (t) {
  ...
  function a(t, e, i, n, r) {
    for (
      ...
      r > _ ? (p = l) : (h = l), (l = (h + p) / 2), (_ = s(t, i, l)), ++u;
    return s(e, n, l);
  }
  function p(t, e, i, n) {
    return 0 === i
      ...
      (e.prototype.loadMainlineKeys = function (t, e) {
        for (var i = 0; i < e.length(); i++) {
          for (
            ...
            n.addBoneRef(r.getRef(o));
          r.processed();
          for (
            var s = e.getChildNodes(i, "object_ref"), a = 0;
            a < s.length();
            a++
          )
            n.addObjectRef(s.getRef(a));
          s.processed(), t.add(n);
        }
      }),
  ...
  var e = (function () {
    ...
    return (
      ...
      (e.prototype.setKey = function (i, n, r, o) {
        ...
        (this.name = s.name),
          (this.objectInfo =
            -1 === s.objectRef ? null : i.getObjectInfoById(s.objectRef));
        var a = s.at(o),
      ...
      (e.prototype.rotatePosition = function (t) {
        ...
        if (0 !== e || 0 !== i) {
          var n = t * (Math.PI / 180),
            r = Math.cos(n),
            o = Math.sin(n);
          (this.transformed.x = e * r - i * o),
            (this.transformed.y = e * o + i * r);
        }
      }),
  ...
  var e = (function (e) {
    function i(i, n, r, o, s, a) {
      e.call(this, i, null),
        ...
        (this._spriter = n),
        (this._entityName = o),
        (this._entity = n.getEntityByName(o)),
        (this._textureKey = r),
        (this._root = new t.SpatialInfo());
      for (var p = 0; p < this._entity.variablesLength; p++)
        this._vars[p] = this._entity.getVariableById(p).clone();
      (this._charMapStack = new t.CharMapStack(this._entity)),
        ...
        void 0 === s || null === s
          ...
          : "number" == typeof s
          ? this.playAnimationById(s)
          : this.playAnimationByName(s);
    }
    return (
      __extends(i, e),
      ...
      (i.prototype.setBones = function (e, i) {
        ...
        for (var n = 0; n < e.length; n++) {
          ...
          s.setOn(!0),
            (s.parent = r.parent),
            (s.timelineKey !== r.key || s.timeline !== r.timeline || i) &&
              s.setKey(this._entity, this._animation, r.timeline, r.key);
        }
      }),
      (i.prototype.setObjects = function (e, i) {
        ...
        for (var r = !1, n = 0; n < e.length; n++) {
          var o = e[n],
            s = null,
            a = null;
          void 0 === this._objects[o.id]
            ? ((a = new Phaser.Sprite(this.game, 0, 0, this._textureKey)),
              (s = new t.SpriterObject(this, a)),
              (this._objects[o.id] = s),
              this.add(a))
            : ((s = this._objects[o.id]), (a = s.sprite)),
            (s.parent = o.parent),
            (s.type = this._animation.getTimelineById(o.timeline).objectType),
            0 === s.type &&
              (s.setOn(!0),
              s.sprite.z !== o.z && ((s.sprite.z = o.z), (r = !0))),
            (s.timelineKey !== o.key || s.timeline !== o.timeline || i) &&
              s.setKey(this._entity, this._animation, o.timeline, o.key);
        }
        r && this.sort();
      }),
                ...
                for (var a = 0; a < this._spriter.tagsLength; a++) {
                  ...
                  s & p &&
                    this.onTagChange.dispatch(
                      this,
                      this._spriter.getTagById(a).name,
                      (o & p) > 0
                    );
                }
                break;
