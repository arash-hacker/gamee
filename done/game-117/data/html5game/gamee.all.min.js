...
//
// Wrappers for `$pandaNaive` object on diferent platforms which
...
(function(global) {
	...
	var pandaNaive = {
		 ...
		 * Gamee Mobile App 
		 */
		function gameeMobile(pandaNaive) {
			pandaNaive.updateScore = function(score) {
				window.location.href = "panda://score/" + score;
			};

			pandaNaive.requestController = function(type) {
				window.location.href = "panda://request-controller/" + type;
			};

			pandaNaive.gameOver = function() {
				window.location.href = "panda://game-over";
				
			};

			pandaNaive.gameStart = function() {
				window.location.href = "panda://game-start";
			};

			pandaNaive.gameLoaded = function() {
			...
			pandaNaive.type = 'gamee-mobile';
		}

		/**
		 * Gamee simulator and validator
		 */
		function gameeSimulator(pandaNaive) {
			...
			pandaNaive.type = 'gamee-simulator';
		}

		/**
		 * Gamee Web App
		 */
		function gameeWeb(pandaNaive) {
			...
			pandaNaive.additionalController = function(type) {
			...
			pandaNaive.gamePaused = function() {
	...
	if (/iphone|ipod|ipad|android/.test(userAgent)) {    
		...
		gameeSimulator(pandaNaive);    
    } else {
		console.error('No gamee enviroment matched');
	}

	// export to global scope
	global.$pandaNaive = pandaNaive;
}(this));
...
var gamee = function(global) {
	 ...
	 *
	 * _There is also [$pandaNaive](gamee_native.js.html) global object 
	...
	Object.defineProperty(gamee, 'score', {
		...
		set: function(newScore) {
			...
			global.$pandaNaive.updateScore(score);
	...
	if (global.$pandaNaive.type === 'gamee-web') {
...
(function(global, gamee) {
	...
	gamee.controller = {
		...
		requestController: function (type, opts) {
			...
			global.$pandaNaive.requestController(type);
		...
		additionalController: function(type, opts) {
			var controller = createController(type, opts);
			global.$pandaNaive.additionalController(type);
