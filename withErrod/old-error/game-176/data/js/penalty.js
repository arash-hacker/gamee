...
(function (Penalty) {
    ...
    var Keeper = (function () {
        function Keeper(playState) {
            ...
            this._shadow = new Phaser.Image(Penalty.Global.game, Keeper.START_X, Keeper.START_Y, "atlas0", "keeperShadow");
                    ...
                    if (ballTargetPos.x - ballGoalRadius >= Penalty.Goal.INNER_LX1 && ballTargetPos.x + ballGoalRadius <= Penalty.Goal.INNER_RX1) {
                        ...
                        while (targetId-- != 0) {
                            ...
                            if (Phaser.Circle.intersects(ballCircle, this._tmpCircle2.setTo(target.x, target.y, target.width))) {
                                ...
                                this.bonus = Phaser.Circle.intersects(ballCircle, this._tmpCircle2.setTo(bonus.x, bonus.y, 58));
                                break;
                            }
                        }
                        if (targetId < 0)
...
(function (Penalty) {
    ...
    var Play = (function (_super) {
        ...
        Play.prototype.onTargetHit = function (pos) {
            ...
            var score = 1;
            if (pos.distance(target.position, false) <= Penalty.GoalTargetData.DEF_DIAMETER / 3)
                score = 2;
