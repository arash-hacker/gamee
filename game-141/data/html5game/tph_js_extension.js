...
{   
    ...
    {        
        ...
        controller.buttons.left.on('keydown', function() { gmCallback.gamee_onDirKey(-1); });
        controller.buttons.right.on('keydown', function() { gmCallback.gamee_onDirKey(1); }); 
        */
        var controller = gamee.controller.requestController('Touch');
        
        controller.on('touchstart', function(data) { gmCallback.gamee_onTouchStart(data.position.x); });
        controller.on('touchmove', function(data) { gmCallback.gamee_onTouchMove(data.position.x); });
